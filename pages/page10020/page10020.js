...
var pageData    = {
  ...
  prevPage:0,
      ...
      dynamicVesselComps: [],
      communityComps: [],
      franchiseeComps: [{"compid":"franchisee_list4","param":{"id":"list-623181459674","form":"app_shop","page":1,"app_id":"T404OMKoT3","sort_key":"distance","sort_direction":1,"idx_arr":{"idx":"category","idx_value":"24369"}}}],
      cityLocationComps: [],
      onLoad: function (e) {
    this.setData({
