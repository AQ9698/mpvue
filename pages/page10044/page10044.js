...
var pageData    = {
  ...
  prevPage:0,
      ...
      dynamicVesselComps: [],
      communityComps: [],
      franchiseeComps: [{"compid":"franchisee_list3","param":{"id":"list-425846242321","form":"app_shop","page":1,"app_id":"T404OMKoT3","sort_key":"distance","sort_direction":1}}],
      cityLocationComps: [],
      onLoad: function (e) {
    this.setData({
